...
class Cadastro 
{
    ...
    public static function insert($dados)
    {
        ...
        $connPdo = new \PDO(dbDrive.':host='.dbHost.'; dbname='.dbName, dbUser, dbPass);
        $sql = "insert into $tabela (nome_form, email_form,  telefone_form, data, hora, servicos, tratamento, quimica, observadores, id_cliente) values (:nome_form, :email_form, :telefone_form, :data, :hora, :servicos, :tratamento, :quimica, :observadores, :id_cliente)"  ;
        $stmt = $connPdo->prepare($sql);
        ...
        $stmt->bindValue(':observadores' , $dados['observadores']) ;
        $stmt->execute() ;
    ...
    public static function alterar($id, $dados)
    {
        ...
        $connPdo = new \PDO(dbDrive.':host='.dbHost.'; dbname='.dbName, dbUser, dbPass);
        $sql = "update $tabela (nome_form, email_form,  telefone_form, data, hora, servicos, tratamento, quimica, observadores, id_cliente) values (:nome_form, :email_form, :telefone_form, :data, :hora, :servicos, :tratamento, :quimica, :observadores, :id_cliente)"  ;
        $stmt = $connPdo->prepare($sql);
        $stmt->bindValue(':nome_form' , $dados['nome_form']) ;
        $stmt->bindValue(':email_form' , $dados['email_form']) ;
        $stmt->bindValue(':telefone_form' , $dados['telefone_form']) ;
